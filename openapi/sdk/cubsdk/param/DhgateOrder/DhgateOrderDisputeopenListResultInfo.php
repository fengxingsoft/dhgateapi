...
class DhgateOrderDisputeopenListResultInfo
{
    ...
    /*
     * disputeOpenDate 	String 	必须 	纠纷开启时间 	日期格式：yyyy-MM-dd HH:mm:ss,精确到秒；示例值：2014-01-12 18:20:21
     */
    private $disputeOpenDate;
    public function GetDisputeOpenDate(){
        return $this->disputeOpenDate ;
    }
    /*
    ...
    * isWarn 	Boolean 	必须 	是否需要特别注意的订单（如高风险订单、售后纠纷订单等） 	值为false或null表示订单正常，true表示此订单需要特别注意一下，例如，防止高风险订单直接发货
    ...
    public function setStdResult($stdResult) {
        ...
        if (array_key_exists ( "disputeOpenDate", $this->stdResult )) {
            $this->disputeOpenDate = $this->stdResult->{"disputeOpenDate"};
        }
    ...
    public function setArrayResult($arrayResult) {
        ...
        if (array_key_exists ( "disputeOpenDate", $this->arrayResult )) {
            $this->disputeOpenDate = $arrayResult['disputeOpenDate'];
        }

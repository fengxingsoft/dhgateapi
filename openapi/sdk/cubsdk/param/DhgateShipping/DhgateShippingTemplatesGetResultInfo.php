...
class DhgateShippingTemplatesGetResultInfo
{
/*
 ...
 */
    ...
    public function setStdResult($stdResult) {
        ...
        if (array_key_exists ( "shippingmodelTypeList", $this->stdResult )) {
            $this->shippingmodelTypeList = $this->stdResult->{"shippingmodelTypeList"};
        }
        ...
        if (array_key_exists ( "shippingmodelTypeList", $this->stdResult )) {
            ...
            $DhgateShippingTemplatesGetResultInfoDetail=new DhgateShippingTemplatesGetResultInfoDetail();
            $DhgateShippingTemplatesGetResultInfoDetail->setArrayResult($arrayobject );
            $this->shippingmodelTypeList = $DhgateShippingTemplatesGetResultInfoDetail;
        }
    }
    private $arrayResult;

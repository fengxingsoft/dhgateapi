...
class DhgateCategoryPubAttrListInfo
{
    /*
     * attrId
     * Long 	必须
     * 属性Id 	选择发布类目基本信息的属性Id值, 示例值：844400。特殊的属性Id有：品牌属性的属性Id:99。
     */
    private $attrId;
    ...
    /*
     * categoryPubAttrValList
     * CategoryPubAttrVal[] 	必须
     * 发布类目属性值 	发布类目属性值
     */
     ...
     * defined
     * String 	必须
     * 属性的属性值是否可以自定义修改 	1：是 0：否 ，只对多选、单选有效;示例值：1
     */
    private $defined;
     ...
     * located
     * String 	必须
     * 是否定位属性 	1：定位属性，0：非定位属性，定位属性不可能是销售或购买属性;为平台定义好的属性值卖家不可更改;示例值：1
     */
    private $located;
     ...
     * required
     * String 	必须
     * 是否为必填项 	设置该属性设置是否为必填项；1：必填项， 0：非必填项;示例值：1
     */
    private $required;
     ...
     * saleAttr
     * String 	必须
     * 是否销售属性 	1：是销售属性，0：非销售属性，通过该属性定义价格;示例值：1
     */
    private $saleAttr;
     ...
     * style
     * String 	必须
     * 类目选择样式 	类目相关参数的选择样式 ；1：文本 2：图片 3：图文；示例值：1
     */
    private $style;
     ...
     * type
     * String 	必须
     * 类目选择形式 	类目相关参数选择形式 ；1：多选框 2：下拉框 4：字符型输入框 5：数值型输入框;示例值：1
     */
    private $type;
    ...
    public function setStdResult($stdResult)
    {
        ...
        if (array_key_exists("categoryPubAttrValList", $this->stdResult)) {
            ...
            for ($i = 0; $i < count($object); $i++) {
                ...
                $DhgateCategoryPubAttrListCategoryPubAttrValListInfo = new DhgateCategoryPubAttrListCategoryPubAttrValListInfo();
                $DhgateCategoryPubAttrListCategoryPubAttrValListInfo->setStdResult($arrayobject);
                $this->categoryPubAttrValList[$i] = $DhgateCategoryPubAttrListCategoryPubAttrValListInfo;
            }
        }
    }
    ...
    public function setArrayResult($arrayResult)
    {
        ...
        if (array_key_exists("categoryPubAttrValList", $this->arrayResult)) {
            ...
            for ($i = 0; $i < count($categoryPubAttrValListResult); $i++) {
                $this->categoryPubAttrValList[$i] = new DhgateCategoryPubAttrListCategoryPubAttrValListInfo();
                $this->categoryPubAttrValList[$i]->setArrayResult($categoryPubAttrValListResult[$i]);
            }

...
class DhgateCategoryAttrvalListGetParam
{
/*
...
/*
 * catePubAttrValId 	String 	可选 	发布属性值ID，如果获取自定义属性，值传入0即可。如果父级属性是品牌属性则可不传dh.category.attrval.list接口用这个值 	通过调用dh.category.get2.0接口获取属性的发布属性值id,示例值：11106880
 */

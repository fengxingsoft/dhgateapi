...
use ArrayObject;
class DhgateItemLeadingUpdateListResult{
    ...
    public function setStdResult($stdResult) {
        ...
        if (array_key_exists ( "resultList", $this->stdResult )) {
            ...
            for($i = 0; $i < count ( $object ); $i ++) {
                ...
                $DhgateItemLeadingUpdateListResultInfo=new DhgateItemLeadingUpdateListResultInfo();
                $DhgateItemLeadingUpdateListResultInfo->setArrayResult($arrayobject );
                $this->resultList[$i] = $DhgateItemLeadingUpdateListResultInfo;
            }
        }
    }
    private $arrayResult;

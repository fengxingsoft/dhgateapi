...
use ArrayObject;
class DhgateItemDownShelfListResult{
/*
...
//                $DhgateItemDownShelfListResultInfo=new DhgateItemDownShelfListResultInfo();
//                $DhgateItemDownShelfListResultInfo->setArrayResult($arrayobject );
//                $this->resultList[$i] = $DhgateItemDownShelfListResultInfo;
//            }
//        }
    }
    private $arrayResult;
    public function setArrayResult($arrayResult) {
        ...
        if (array_key_exists ( "resultList", $this->arrayResult )) {
            ...
            for($i=0;$i<count($resultListResult);$i++){
                $DhgateItemDownShelfListResultInfo=new DhgateItemDownShelfListResultInfo();
                $DhgateItemDownShelfListResultInfo->setStdResult($arrayobject );
               $this->resultList[$i] = $DhgateItemDownShelfListResultInfo;
            }
        }
    }

...
use ArrayObject;
class DhgateItemDeleteListResult{
 	/*
    ...
    public function setStdResult($stdResult) {
        ...
        if (array_key_exists ( "resultList", $this->stdResult )) {
            ...
            for($i = 0; $i < count ( $object ); $i ++) {
                ...
                $DhgateItemDeleteListResultInfo=new DhgateItemDeleteListResultInfo();
                $DhgateItemDeleteListResultInfo->setArrayResult($arrayobject );
                $this->resultList[$i] = $DhgateItemDeleteListResultInfo;
            }
        }
    }
    private $arrayResult;
